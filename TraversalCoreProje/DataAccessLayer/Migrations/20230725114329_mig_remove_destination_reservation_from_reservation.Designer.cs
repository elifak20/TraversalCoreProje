...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20230725114329_mig_remove_destination_reservation_from_reservation")]
    partial class mig_remove_destination_reservation_from_reservation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.Property<int>("DestnationID")
                        .HasColumnType("int");

                    b.HasKey("CommentID");

                    b.HasIndex("DestnationID");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    b.HasOne("EntityLayer.Concrete.Destination", "Destnation")
                        .WithMany("Comments")
                        .HasForeignKey("DestnationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Destnation");
                });
